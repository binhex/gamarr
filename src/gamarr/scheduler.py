...
def _build_kwargs(config: Config) -> dict[str, Any]:
    ...
    return {
        ...
        "metacritic_cache_ttl_hours": mc_cfg.metacritic_cache_ttl_hours,
        "metacritic_enabled": mc_cfg.metacritic_enabled,
        "metacritic_max_games": mc_cfg.metacritic_max_games,
        "metacritic_cutoff_date": mc_cfg.metacritic_cutoff_date,
